...
$er="select * from faculty where id='".$_SESSION['uid']."'";
$fr=mysql_query($er);
...
{
mysql_query("update faculty set uname='".$_REQUEST['sname']."',
	...
	<table cellpadding="0" cellspacing="0" align="center" width="1000" border="1">
			...
			<tr>
				...
				<table cellpadding="10" cellspacing="10" align="center" width="50%" border="0">	
						...
						<tr>
								<td>Faculty Name</td><td><input type="text" name="sname" value="<?php echo $rec[1]; ?>" required placeholder="User Name" /></td>
						</tr>
						<tr>
