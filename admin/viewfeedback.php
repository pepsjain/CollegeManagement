...
$f=mysql_query("select * from feedback");

if(isset($_REQUEST['delid']))
{
mysql_query("delete from feedback where id='".$_REQUEST['delid']."'");
...
<body>
	<table cellpadding="0" cellspacing="0" align="center" width="1000" border="0">
			...
			<tr>
				...
				<table cellpadding="10" cellspacing="0" align="center" width="90%" border="0">
						<tr class="label"><td >Sno</td><td>Name</td><td>Mobile No</td><td>Mail Id</td><td>Query</td><td>Update</td><td>Delete</td></tr>
						<?php 
						$sno=1;
						...
						<td><a href="viewfeedback.php?delid=<?php echo $rec[0];?>">Delete</a></td>
						</tr>
						<?php
						$sno++;
						}
